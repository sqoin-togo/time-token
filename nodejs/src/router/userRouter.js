...
router.get('/getAllUsers', urlencodedParser, (req, res, next) =>
    userController.getAllUsers(req.query.search)
    .then(user => {
        res.send(user);
    })
    .catch(next));
...
router.post('/updateUserPhotoByEmail', (req, res, next) =>
    userController.getRawBody(req)
    .then(user => {
        return userController.updateUserPhotoByEmail(req, user)
    })
    .then(msg => {
        res.send(msg);
    })
...
router.get('/getUserIdByEmail', urlencodedParser, (req, res, next) =>
    userController.getUserIdByEmail(req)
    .then(user => {
        res.send(user);
    })
    .catch(next));
